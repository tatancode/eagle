...
const Sidebar = () => (
	<div className="fixed left-0 top-0 h-full w-16 bg-sidebar-navy flex flex-col text-white">
...
const Header = ({ title, onBack }) => (
	<div className="bg-dashboard-blue text-white p-6 flex justify-between items-center">
		{onBack && (
			<button
				onClick={onBack}
				className="mr-4">
...
const QuizTile = ({ onClick }) => (
  ...
  >
    <div className="flex items-center justify-between mb-4">
      ...
      <svg className="w-8 h-8 text-[#B52048]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
      </svg>
    </div>
    <p className="text-gray-600 mb-4">Test your knowledge with interactive quizzes on American Government topics.</p>
			...
			{parts.map((part, index) => {
				if (part.startsWith('[') && part.endsWith(']')) {
					...
					return (
						<span
							key={index}
							className="text-[#B52048] font-medium">
							{highlightedText}
						</span>
					);
				}
